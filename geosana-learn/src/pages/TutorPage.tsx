...
export default function TutorPage() {
  ...
  useEffect(() => {
    ...
    chatRef.current = ai.chats.create({
      ...
      config: {
        systemInstruction: 'Ты — ИИ-Тьютор образовательной платформы GeoSana. Твоя задача — помогать пользователям изучать географию, природу, экономику и историю Казахстана. Отвечай дружелюбно, информативно и на русском языке. Используй эмодзи для оживления текста.',
      }
    });
  }, []);
  ...
  const handleModeChange = async (newMode: TutorMode) => {
    ...
    const systemInstruction = newMode === 'qa' 
      ? 'Ты — ИИ-Тьютор образовательной платформы GeoSana. Твоя задача — помогать пользователям изучать географию, природу, экономику и историю Казахстана. Отвечай дружелюбно, информативно и на русском языке. Используй эмодзи для оживления текста.'
